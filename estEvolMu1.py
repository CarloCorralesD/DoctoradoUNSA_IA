...
# usar la estrategia Evolutiva Mu+1 para calcular el valor minimo de la funcion f(x,y) = (x + 2y -7)2 + (2x + y - 5)2
...
file = open("MuMasuno.txt",'w')
file.write("Estrategia Evolutiva  Mu+1\n")
file.write("Parametros:\n")
file.write("- Cantidad de individuos (Mu): 8\n")
file.write("- Cantidad de descendientes (Lamb): 1\n")
...
for i in range(iteraciones):
    file.write("\n**** Iteracion "+str(i)+" ****\n")
    file.write("Generar Descendiente 1\n")
